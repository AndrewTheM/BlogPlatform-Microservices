...
namespace BlogPlatform.Posts.BusinessLogic.Services
{
    public class PostService : IPostService
    {
        ...
        public async Task<PostResponse> FindPostAsync(int id)
        {
        ...
        {
            Post completePost = await _unitOfWork.Posts.GetCompletePostAsync(titleIdentifier);
        ...
        public async Task<PostResponse> PublishPostAsync(PostRequest postDto, string authorId)
        {
        ...
        public async Task EditPostAsync(int id, PostRequest postDto)
        {
            Post post = await _unitOfWork.Posts.GetPostWithContentAsync(id);
        ...
        public async Task SetTagsOfPostAsync(int id, params string[] tagNames)
        {
            Post post = await _unitOfWork.Posts.GetPostWithTagsAsync(id);
        ...
        public async Task<bool> CheckIsPostAuthorAsync(int id, string userId)
        {
            Post post = await _unitOfWork.Posts.GetByIdAsync(id);
